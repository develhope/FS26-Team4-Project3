...
export default function PravacyAccount() {
  ...
  return (
    <div className="bg-purple-500 text-white h-screen p-4">
      ...
      <div className="mb-8">
        ...
        <div>
          <p>
            se imposti il tuo profilo come pubblico,chiunque su PetVerse e fuori
            da PetVerse puo vedere il tuo profilo e i relativi post anche se non
            ha un account PetVerse.
          </p>
          <p>
            se imposti il tuo profilo come privato, solo i followers che approvi
            possono vedere cosa condividi,inclusi i tuoi video e le tue foto, e
            le liste dei tuoi followers e dei Pet che segui
          </p>
          <p>
            alcune inforzioni del tuo profilo, come l'immagine del profilo e il
            nome utente, sono visibili a tutti su PetVerse e fuori da Petverse.
          </p>
        </div>
      </div>
      <div className="mb-8">
